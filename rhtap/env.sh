...
export IMAGE_URL=${IMAGE_URL-quay.io/acmiel/bootstrap:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/acmiel-rhtap/tssc-dev-gitops
...
export REKOR_HOST=https://rekor-server-rhtap-tas.apps.cluster-lh268.lh268.sandbox817.opentlc.com
export IGNORE_REKOR=false
export TUF_MIRROR=https://tuf-rhtap-tas.apps.cluster-lh268.lh268.sandbox817.opentlc.com
# Update forced CI test Mon Nov 25 01:58:14 PM CET 2024
